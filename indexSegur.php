    ...
    <div id="contenidoTxt">
        <div id="conttxt1">
           <form id="conttxt1_check">
               ...
               <label for="comprar" id="conttxt1_label_comprar">COMPRAR</label>
               <input type="checkbox" name="alquilar" value="alquilar" id="conttxt1_check_alquilar" />
               <label for="alquilar" id="conttxt1_label_alquilar">ALQUILAR</label>
           </form>
        </div>
        <div id="conttxt2">
...
<script type="text/javascript" src="js/leebd.js"></script>
